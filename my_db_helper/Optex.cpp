...
#include "stdafx.h"
#include "CmdHdr.h"     /* See Appendix A. */
#include "Optex.h"
...
volatile LONG CFastMutex::fResourceInUse =FALSE ;


void CFastMutex::Enter()
{			 
	while (InterlockedExchange (&fResourceInUse, TRUE) == TRUE)
		Sleep(10);

	//return TRUE;
}	

void CFastMutex::Leave()
{
	InterlockedExchange(&fResourceInUse, FALSE);
	//return TRUE;
}